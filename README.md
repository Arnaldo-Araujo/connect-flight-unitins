...
**Funcionalidades:**
* **Componentização:** Divisão do layout em Header, Main e Footer.
...
1.  **Clone o repositório:**
    ```bash
    git clone [https://github.com/Arnaldo-Araujo/connect-flight-unitins.git](https://github.com/Arnaldo-Araujo/connect-flight-unitins.git)
    ```
